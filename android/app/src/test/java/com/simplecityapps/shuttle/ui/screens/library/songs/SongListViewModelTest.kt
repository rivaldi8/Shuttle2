...
class SongListViewModelTest {
    ...
    fun createViewModel(): SongListViewModel {
    ...
    fun mockSongImportState(state: SongImportState) =
        every { mockMediaImportObserver.songImportState } returns
            MutableStateFlow(state)

    fun mockSortOrderPreference(sortOrder: SongSortOrder) =
        every { mockSortPreferenceManager.sortOrderSongList } returns
            sortOrder
}
